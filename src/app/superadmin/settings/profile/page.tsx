...
export default function SuperAdminProfilePage() {
    ...
    return (
        <div className="space-y-6">
            <div>
                <h1 className="text-3xl font-bold">Profil Super Admin</h1>
            ...
            <div className="grid gap-6 md:grid-cols-2">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Detail akun Super Admin</CardDescription>
                    </CardHeader>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Perbarui nama dan email</CardDescription>
                    </CardHeader>
                    <CardContent>
